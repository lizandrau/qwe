...
//       console.log('mya');
//     }
//     timeout = setTimeout( () => func(context, args), (wait - 500));
//   }();
// }
const debounce = function(func, wait) {
  let timeout;
...
$(document).on("mouseover", ".three-categories__category-en", debounce( (e) => define(e), 1000));
$(document).on("mouseout", ".three-categories__category-en", debounce( (e) => define(e), 1000));
